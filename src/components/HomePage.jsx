...
const HomePage = () => {
    ...
    return (
        <>
            <nav id="navigation" className={menuOpen ? 'menu-open' : ''}>

                <div className="wrapper">
                    <svg width="133" height="18" viewBox="0 0 133 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <text x="0" y="14" fontFamily="Arial, sans-serif" fontSize="20" fill="black">Link</text>
                        <text x="30" y="14" fontFamily="Arial, sans-serif" fontWeight="bold" fontSize="20" fill="green">Insight</text>
                    </svg>

                    <div className="menu">
                        <ul>
                            <li><a className="active" onClick={() => closeMenu()} href="#home">Início</a></li>
                    ...
                    <button
                        ...
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 20H30" stroke="#FFFAF1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M10 12H30" stroke="#FFFAF1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M18 28L30 28" stroke="#FFFAF1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </button>
                    ...
                    <div className="cards">
                        ...
                        <div className="card">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M17.091 8.18188L10.091 15.1819L6.90918 12.0001" stroke="#00856F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                ...
                <div className="wrapper">
                    ...
                    <div className="col-a">
                        <a className="logo" href="#home">
                            <svg width="133" height="18" viewBox="0 0 133 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <text x="0" y="14" fontFamily="Arial, sans-serif" fontSize="14" fontWeight="bold" fill="white">LinkInsight</text>
                            </svg>
                        </a>
